...
create table app_users (
  ...
  rank text check (rank in ('VIP', 'Common')) not null,
...
create table profiles (
  id uuid default gen_random_uuid() primary key,
  name text not null,
  rank text not null, -- Removed check constraint for flexibility (formerly S/A/B/C)
  class_type text,
  description text,
  location text,
  age int,
...
(
  '塞拉菲娜', 'Common', 'Mage', '深渊之星。以优雅和毁灭性的智慧闻名。', '安徽 合肥', 22, 172, 50, 'D', '平面模特',
...
(
  '尤娜', 'Common', 'Healer', '温柔的灵魂，拥有抚慰疲惫旅人的力量。', '上海', 20, 165, 48, 'C', '学生',
...
(
  '小雅', 'Common', 'Healer', '成熟稳重，性格开朗，能够提供极佳的情绪价值。', '安徽 合肥巢湖', 32, 165, 75, 'C', '无业',
